...
function submitContato(){
    ...
    $.ajax({
        ...
        data: "contato-nome=" + nome + "&contato-email=" + email + "&contato-empresa=" + empresa + "&contato-tel=" + telefone + "&contato-assunto=" + assunto + "&contato-mensagem=" + mensagem,
