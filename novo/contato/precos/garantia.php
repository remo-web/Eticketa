...
$nome = $_POST["p_garantia-nome"];

//email
if (empty($_POST["p_garantia-email"])) {
    $error .= "Email is required ";
} else {
    $email = $_POST["p_garantia-email"];
}

$empresa = $_POST["p_garantia-empresa"];
$quantidade = $_POST["etka_preco-garantia_slider-label_input"];
$endereco = $_POST["p_garantia-endereco"];

 
$To = "raphael.pais@eticketa.com.br";
$uglySubject = "[Site | Preços] garantia para Delivery";
